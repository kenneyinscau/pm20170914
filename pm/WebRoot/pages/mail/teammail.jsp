                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="affiche!addAffiche.action">                        
                                        <div class="form-group">
                                            <label>标题</label>
                                            <input class="form-control" placeholder="输入公告标题" name="affiche.title">
                                        </div>  
                                        <div class="form-group">
                                            <label>公告内容</label>
                                            <textarea class="form-control" rows="3" name="affiche.content"></textarea>
                                        </div>
